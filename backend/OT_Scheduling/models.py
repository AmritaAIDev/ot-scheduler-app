...
class Department(models.Model):
    ...
    # "Plastic and Surgery"), so canonicalization lives here instead of a hardcoded Dart function.
...
class Procedures(models.Model):
    ...
    departments = models.ManyToManyField(Department, related_name='procedures', blank=True)
